...
env = environ.Env(
    ...
    DELIVERY_FEE=(int, 50),
    FREE_DELIVERY_THRESHOLD=(int, 2500),
)
...
WSGI_APPLICATION = 'hardvendor.wsgi.application'
...
if DEBUG:
    ...
    CORS_ALLOWED_ORIGINS = env.list(
        ...
        default=[
            'https://hardvendor.co.ke',
            'https://www.hardvendor.co.ke',
            'https://hardvendor.pages.dev',
            'https://hardvendor.store',
            'https://admin.hardvendor.store',
            'https://admin-hardvendor.pages.dev',
        ]
    )
