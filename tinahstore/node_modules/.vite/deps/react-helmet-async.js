...
var major = parseInt(import_react4.default.version.split(".")[0], 10);
...
var HelmetDispatcher = class extends import_react5.Component {
  rendered = false;
...
var React19Dispatcher = class extends import_react6.Component {
  componentDidMount() {
  ...
  renderStyle() {
    ...
    return style.map((attrs, i) => {
      ...
      return import_react6.default.createElement("style", { key: i, ...props });
    });
  }
  renderNoscript() {
